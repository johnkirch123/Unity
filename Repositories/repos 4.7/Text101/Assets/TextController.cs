...
public class TextController : MonoBehaviour {
	...
	void mirror () {
		text.text = "The dirty old mirror on the wall seems loose.\n\n" +
					"Press T to take Mirror, or R to Return to roaming your cell";
	...
	void cell_mirror () {
		text.text = "You are still in your cell, and you STILL want to escape! There are " +
					...
					"Press K to view sheets, N to view lock, or R to Return to roaming your cell";
		if (Input.GetKeyDown(KeyCode.R)) {myState = States.cell;}
		else if (Input.GetKeyDown(KeyCode.K)) {myState = States.sheets_1;}
		else if (Input.GetKeyDown(KeyCode.N)) {myState = States.lock_1;}
	}
